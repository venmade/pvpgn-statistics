...
if (!isset($user) || $user == "") {
    ...
    if ($display_stats[0]['username'] == 'NO SUCH USER')
        $display_stats = '<tr><td bgcolor="#000000" colspan="11"><center><table><tr><td><img height=18 src="themes/bnet/images/w3tft/unknown.gif" width=26></td><td><small>No such user</small></td></tr></table></center></td></tr>';
    else if (count($display_stats) == 0)
        $display_stats = '<tr><td bgcolor="#111111" colspan="11"><small><center>No users for this game</center></small></td></tr>';
    else
